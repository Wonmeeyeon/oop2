	...
	public Employee(String name, String email, String dept, String position, int salary) {
		...
		/*
		 ...
		 class Person {
		 	...
		 	public Person(String name, String email) {  <------Employee에서 super(String, String)로
